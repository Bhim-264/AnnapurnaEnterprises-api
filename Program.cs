...
builder.Services.AddSwaggerGen(c =>
{
    ...
    {
        Title = "AnnapurnaEnterprises.Api",
        Version = "v1"
    });
...
builder.Services.AddCors(options =>
{
    ...
    {
        policy
            .WithOrigins("https://guileless-genie-60215d.netlify.app")
            .AllowAnyHeader()
            .AllowAnyMethod();
    });
});
